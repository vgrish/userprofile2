...
userprofile2 is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/userprofile2.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory userprofile2 is now in, and do this:
...
Now, you'll want to change references to userprofile2 in the files in your
new copied-from-userprofile2 repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'userprofile2' to whatever the
name of your component is.

## Copyright Information

userprofile2 is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of userprofile2 the ability to modify, distribute
and use userprofile2 in MODx development as they see fit, as long as attribution
