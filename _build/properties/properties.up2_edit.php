...
$tmp = array(
    ...
    'tplContentTabPaneInputRow'    => array(
        'type'  => 'textfield',
        'value' => '@INLINE <div class="form-group col-sm-12 [[+class]]"><label for="[[+nameout]]">[[+name]][[+required]]</label><input type="[[+type_out]]" name="[[+nameout]]" class="form-control [[+class]]" value="[[+value]]" [[+disabled]] [[+readonly]]><p class="help-block message"></p></div>',
    ),
    'tplContentTabPaneTextareaRow' => array(
        'type'  => 'textfield',
        'value' => '@INLINE <div class="form-group col-sm-12 [[+class]]"><label for="[[+nameout]]">[[+name]][[+required]]</label><textarea name="[[+nameout]]" class="form-control" [[+disabled]] [[+readonly]]>[[+value]]</textarea><p class="help-block message"></p></div>',
    ),
    'tplTypeRow'                   => array(
        'type'  => 'textfield',
        'value' => '@INLINE <option value="[[+id]]" data-type="[[+id]]" [[+selected]]>[[+name]]</option>',
    ),
    'excludeTabs'                  => array(
        'type'  => 'textfield',
        'value' => '',
