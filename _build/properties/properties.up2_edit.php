...
$tmp = array(
	...
	'tplContentTabPaneInputRow' => array(
		'type' => 'textfield',
		'value' => '@INLINE <div class="form-group col-sm-12 [[+class]]"><label for="[[+nameout]]">[[+name]][[+required]][[readonly]]</label><input type="[[+type_out]]" name="[[+nameout]]" class="form-control" value="[[+value]]" [[+disabled]]><p class="help-block message"></p></div>',
	),
	'tplContentTabPaneTextareaRow' => array(
		'type' => 'textfield',
		'value' => '@INLINE <div class="form-group col-sm-12 [[+class]]"><label for="[[+nameout]]">[[+name]][[+required]][[readonly]]</label><textarea name="[[+nameout]]" class="form-control" [[+disabled]]>[[+value]]</textarea><p class="help-block message"></p></div>',
	),
	'tplTypeRow' => array(
		'type' => 'textfield',
